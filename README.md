...
# Deskripsi Proyek
Proyek ini merupakan sebuah program UAS yang berfungsi untuk membantu dalam perhitungan
dan dapat digunakan oleh siapa saja Program ini dapat bermanfaat bagi
orang dan membantu meringankan pekerjaan Program ini bertujuan untuk memudahkan siapa saja yang memakainya.
# program soal1;
uses crt;
